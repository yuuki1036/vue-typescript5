...
const vFocus = {
  ...
  mounted: (el: HTMLElement, binding: DirectiveBinding) => {
    el.focus()
    if (binding.modifiers.alert) el.style.backgroundColor = "orange"
  }
}
...
<template>
  <form>
    <div class="form-control">
      ...
      <input id="user-name" name="user-name" type="text" v-model="userName" v-focus.alert />
    </div>
    <div class="form-control">
    ...
    <div class="form-control">
      ...
      <div>
        <input id="how-other" name="how" type="radio" value="radio" v-model="radios" />
